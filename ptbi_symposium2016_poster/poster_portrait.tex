...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\headerbox{Ithaka performance}{name=speed,column=1,span=2,below=results,above=bottom}{ %,bottomaligned=background model}{
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Performances of classification of {\sc Ithaka} (with spaced seeds), and original {\sc Kraken}, 
...
\includegraphics[height=0.39\textheight,keepaspectratio]{images/ithaka_first_results_miseq_fixed.png}\\
\end{tabular}
}
\end{minipage}
