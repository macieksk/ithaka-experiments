...
%       %      
      \bibitem{lmat}
      Ames,~Sasha~K., et al. 
      \newblock Scalable metagenomic taxonomy classification using a reference genome database.
      \newblock In Bioinformatics 29.18 (2013): 2253-2260.      
      \bibitem{kraken}
      ...
      \bibitem{iedera} 
      Seed design has been done with {\sc Iedera} software 
      \newblock \url{http://bioinfo.lifl.fr/yass/iedera}
      \end{thebibliography}
